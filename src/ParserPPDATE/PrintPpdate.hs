...
instance Print PropKind where
  prt i e = case e of
   ...
   PropKindPinit id0 id -> prPrec i 0 (concatD [doc (showString "PINIT") , doc (showString "{") , doc (showString "(") , prt 0 id0 , doc (showString ",") , prt 0 id , doc (showString ")") , doc (showString "}")])
...
instance Print Method where
  prt i e = case e of
   Method id0 id overriding -> prPrec i 0 (concatD [doc (showString "METHOD") , doc (showString "{") , prt 0 id0 , doc (showString ".") , prt 0 id , prt 0 overriding , doc (showString "}")])
