...
* Test case 'automata_communication_case_1' -> There should be 2 calls to method Channel.receive() in 'prop1', and other 2 calls for this method in 'prop2' (4 calls in total).
...
* Test case 'monitor_behaviour' -> The following entries should be found in the log file generated by the monitor, in this exact same order:
 ...
 - Clean from main automaton ([prop])
 - The value of tmp is : 10  ([prop])
 - Template created
...
Test case 'hoare_triples_behaviour' -> 
